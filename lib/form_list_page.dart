...
class FormListPage extends StatelessWidget {
  ...
  Future<List<Map<String,dynamic>>> getFormsList() async {
    final response = await http.get(Uri.http('127.0.0.1:8080', '/v1/t/dbform'));
              ...
              if (snapshot.data == null) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, index) => ListTile(
                    ...
                    onTap: () => {
                      context.go('/form/|forms/${snapshot.data[index]['id']}')
                      },
                  ),
                );
              }
