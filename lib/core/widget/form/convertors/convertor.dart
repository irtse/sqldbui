...
class Convertor {
  ...
  String description, bool require, bool readOnly, dynamic value, String? url, String path, double maxWidth, FormWidgetState comp) {
    ...
    || ((type.contains("time") || type.contains("date")) && readOnly)) { 
        return TextWidget(form : form, schemaName: schemaName, name: name,readOnly: readOnly, 
                          value: value, label: label, require: require, type: type, component: comp,);
    } else if ((type.contains("int") && !isLink) || type.contains("double") || type.contains("float") || type.contains("money") || type.contains("decimal")) { 
      ...
      if (form[name] != null) { value = form[name]; }
        ...
        return DropDownWidget(form: form, schemaName: schemaName, name: name, readOnly: readOnly, value: value, label: label, require: require, 
                    type: type, url: url, path: path, component: comp);
